...
#ifndef GLIO_SLAM_MODELS_PRE_INTEGRATOR_IMU_PRE_INTEGRATOR_HPP_
#define GLIO_SLAM_MODELS_PRE_INTEGRATOR_IMU_PRE_INTEGRATOR_HPP_

#include "GLIO_SLAM/models/pre_integrator/pre_integrator.hpp"
...
public:
    ...
    bool Update1(const IMUData &imu_data,const VelocityData &velocity_data,const GNSSData &gnss_data);
    /**
...
private:
    ...
    void UpdateState1(void);
};

} // namespace GLIO_SLAM

#endif // GLIO_SLAM_MODELS_PRE_INTEGRATOR_IMU_PRE_INTEGRATOR_HPP_
