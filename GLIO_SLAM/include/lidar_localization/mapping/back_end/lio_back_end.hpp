 ...
 */
#ifndef GLIO_SLAM_MAPPING_BACK_END_LIO_BACK_END_HPP_
#define GLIO_SLAM_MAPPING_BACK_END_LIO_BACK_END_HPP_
...
#include "GLIO_SLAM/models/pre_integrator/odo_pre_integrator.hpp"

#include "GLIO_SLAM/models/graph_optimizer/g2o/g2o_graph_optimizer.hpp"
...
class LIOBackEnd {
  public:
    ...
    //addnew
    bool UpdateIMUPreIntegration(const IMUData &imu_data,const VelocityData &velocity_data,const GNSSData &gnss_data);
...
#endif // GLIO_SLAM_MAPPING_BACK_END_LIO_BACK_END_HPP_